  ...
  <div class="container mt-4">
    <div id="kt_carousel_2_carousel" class="carousel carousel-custom slide" data-bs-ride="carousel"
      ...
      <div class="carousel-inner pt-8">
        <div v-for="(slide, index) in slides" :key="slide.id" class="carousel-item" :class="{ active: index === 0 }">
          <img :src="slide.image" class="d-block w-100" alt="Slide image">
          <div class="carousel-caption d-none d-md-block">
            <h5>{{ slide.caption }}</h5>
            <button class="btn btn-primary btn-sm" @click="startEditing(slide.id)">
              Editar
            </button>
          </div>
        </div>
      ...
      <ol class="p-0 m-0 carousel-indicators carousel-indicators-bullet">
        <li v-for="(slide, index) in slides" :key="slide.id" data-bs-target="#kt_carousel_2_carousel"
          :data-bs-slide-to="index" :class="{ 'ms-1': true, active: index === 0 }">
        </li>
      </ol>
      <!--end::Carousel Indicators-->     
    </div>
    <div class="modal" :class="{ 'd-block': editingSlide !== null }" tabindex="-1">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="mb-3">
              ...
              <input type="file" class="form-control" accept=".jpg,.jpeg" @change="handleImageUpload">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" @click="saveEdits(editingSlide!)">Save changes</button>
          </div>
        </div>
      </div>
    </div>
