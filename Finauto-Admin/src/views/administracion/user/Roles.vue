                    ...
                    <div class="card card-flush h-md-100">
                      ...
                      <div class="card-body pt-1">
                        ...
                        <div class="d-flex flex-column text-gray-600">
                          ...
                          <div class="d-flex align-items-center py-2">
                            <span class="bullet bg-primary me-3"></span>View and
                            Edit Financial Summaries
                          </div>
                          <div class="d-flex align-items-center py-2">
                            <span class="bullet bg-primary me-3"></span>Enabled
                            Bulk Reports
                          </div>
                          <div class="d-flex align-items-center py-2">
                            <span class="bullet bg-primary me-3"></span>View and
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="card card-flush h-md-100">
                      ...
                      <div class="card-body pt-1">
                        ...
                        <div class="d-flex flex-column text-gray-600">
                          <div class="d-flex align-items-center py-2">
                            <span class="bullet bg-primary me-3"></span>No Admin
                            Controls
                          </div>
                          <div class="d-flex align-items-center py-2">
                            <span class="bullet bg-primary me-3"></span>View and
                    ...
                    <div class="card card-flush h-md-100">
                      ...
                      <div class="card-body pt-1">
                        ...
                        <div class="d-flex flex-column text-gray-600">
                          ...
                          <div class="d-flex align-items-center py-2">
                            <span class="bullet bg-primary me-3"></span>Response
                  ...
                  <div class="ol-md-4">
                    ...
                    <div class="card h-md-100">
                      ...
                      <div class="card-body d-flex flex-center">
                        ...
                        >
                          <!--begin::Illustration-->
                          <img src="" alt="" class="mw-100 mh-150px mb-7" />
                          <!--end::Illustration-->
                          <!--begin::Label-->
                          <div
...
export default defineComponent({
  ...
  data() {
    return {
      // Aquí puedes definir las propiedades necesarias
    };
  },
  methods: {
    // Aquí puedes definir los métodos necesarios
  },
  mounted() {
