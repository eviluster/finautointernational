      ...
      <div class="card-toolbar">
        ...
        >
          ...
          <button
            ...
            @click="router.push('/admin/promociones/equipamiento/crear')"
          >
...
export default defineComponent({
  ...
  setup() {
    ...
    const promocionesEquipamiento = ref([
      {
        id: 11,
      ...
      {
        id: 13,
        nombre: "Promocion Compresor de Aire",
        codigo: "EQU-003",
    ...
    const tableData = ref<Array<IPromocion>>(promocionesEquipamiento.value);
