<template>
  <div
    class="modal fade"
    id="kt_modal_edit_cajacambio"
    ref="editCajaCambioModalRef"
    tabindex="-1"
    aria-hidden="true"
  >
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
      ...
      <div class="modal-content">
        <!--begin::Modal header-->
        <div class="modal-header" id="kt_modal_edit_cajacambio_header">
          <!--begin::Modal title-->
          <h2 class="fw-bold">Editar caja cambio</h2>
          <!--end::Modal title-->

          <!--begin::Close-->
          <div
            id="kt_modal_edit_cajacambio_close"
        ...
        <Form :validation-schema="schema" @submit="handleSubmit">
          <!-- Campo: Nombre del caja cambio -->
          <div class="mb-4 px-4 py-4 col-11 mx-6">
            <label class="required form-label">Nombre de la caja cambio</label>
            <Field
              name="nameEs"
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const editCajaCambioModalRef = ref<HTMLElement | null>(null);
    ...
    // Sincronizamos los datos de la prop "cajacambio" con el formulario
    watchEffect(() => {
      if (props.cajacambio) {
        formData.value.id = props.cajacambio.id || "";
        formData.value.nameEs = props.cajacambio.name?.es || "";
        formData.value.nameEn = props.cajacambio.name?.en || "";
        formData.value.descriptionEs = props.cajacambio.description?.es || "";
        formData.value.descriptionEn = props.cajacambio.description?.en || "";
      }
    });
