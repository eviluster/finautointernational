<template>
  <div
    class="modal fade"
    id="kt_modal_edit_tiponeumatico"
    ref="editTipoNeumaticoModalRef"
    tabindex="-1"
    aria-hidden="true"
  >
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header" id="kt_modal_edit_provincia_header">
          <!--begin::Modal title-->
          <h2 class="fw-bold">Editar Tipo de Neumático</h2>
          <!--end::Modal title-->
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const editTipoNeumaticoModalRef = ref<HTMLElement | null>(null);
    ...
    // Sincronizamos los datos de la prop "tiponeumatico" con el formulario
    watchEffect(() => {
      if (props.tiponeumatico) {
        formData.value.id = props.tiponeumatico.id || "";
        formData.value.nameEs = props.tiponeumatico.name?.es || "";
        formData.value.nameEn = props.tiponeumatico.name?.en || "";
        formData.value.descriptionEs =
          props.tiponeumatico.description?.es || "";
        formData.value.descriptionEn =
          props.tiponeumatico.description?.en || "";
      }
    });
    ...
    const handleSubmit = async (
      ...
      try {
        ...
        console.error("Error al actualizar la tiponeumatico:", error);
      }
    };

    return {
      editTipoNeumaticoModalRef,
      formData,
      errors,
      schema,
      handleSubmit,
