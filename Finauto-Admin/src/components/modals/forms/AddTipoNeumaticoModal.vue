<template>
  <div
    class="modal fade"
    id="kt_modal_add_tiponeumatico"
    ref="addTipoNeumaticoModalRef"
    tabindex="-1"
    aria-hidden="true"
  >
    <div class="modal-dialog modal-dialog-centered mw-650px miModal">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header" id="kt_modal_add_provincia_header">
          <!--begin::Modal title-->
          <h2 class="fw-bold">Añadir una Tipo de Neumático</h2>
          <!--end::Modal title-->
        ...
        >
          <div class="card shadow-sm">
            <!-- Campo: Nombre del tiponeumatico -->
            <div class="mb-4 px-4 py-4 col-11 mx-6">
              <label class="required form-label"
                >Nombre del tipo de neumatico</label
              >
              <Field
                name="name"
                as="input"
                type="text"
                class="form-control"
                placeholder="Ponga el nombre del tiponeumatico"
              />
...
interface AddTipoNeumaticoFormFields {
  name: string;
  description: string;
}
export default defineComponent({
  name: "AddTipoNeumatico",
  components: {
    Form,
    Field,
    ErrorMessage,
  ...
  setup() {
    ...
    const addTipoNeumaticoModalRef = ref<HTMLElement | null>(null);
    ...
    const { errors } = useForm<AddTipoNeumaticoFormFields>({
    ...
    const handleSubmit = async (
      ...
      try {
        const response =
          await tiponeumaticoStore.addTipoNeumatico(newTipoNeumatico);
        ...
        console.error("Error al agregar tiponeumatico:", error);
        ...
        hideModal(addTipoNeumaticoModalRef.value);
        resetForm();
      }
    };
