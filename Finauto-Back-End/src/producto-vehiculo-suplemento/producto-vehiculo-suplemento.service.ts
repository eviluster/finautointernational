...
@Injectable()
export class ProductoVehiculoSuplementoService  extends BaseServiceCRUD<
ProductoVehiculoSuplemento,
CreateProductoVehiculoSuplementoDto,
UpdateProductoVehiculoSuplementoDto> {
  constructor(
    @InjectRepository(ProductoVehiculoSuplemento)
    private readonly repository: Repository<ProductoVehiculoSuplemento>,
  ) {
    super(repository)
  }
