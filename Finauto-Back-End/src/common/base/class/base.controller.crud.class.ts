import { Body, Delete, Get, Patch, Post, Put, ValidationPipe } from '@nestjs/common';
...
, TService extends CrudService<TCreateDto, TUpdateDto>>
 {
  ...
  @ApiResponse({ status: 200, description: 'El elemento ha sido activado con éxito.', type: ReturnDto })
  @ApiBadRequestResponse({ description: 'Error de validación o datos incorrectos.' })
  @ApiBody({ type: DeleteDto, description: 'ID del elemento a activar.' })
   active( @Body() deleteDto: DeleteDto):Promise<ReturnDto> {
